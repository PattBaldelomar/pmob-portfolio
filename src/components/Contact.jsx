...
const socialLinks = [
  {
    href: 'https://github.com/PattBaldelomar',
  ...
  {
    href: 'https://www.linkedin.com/in/patricia-baldelomar-7351aa149/',
    icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  const Contact = () => {
    return (
      ...
      <section id="contact" className="section pb-20 p-20">
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
          <div className="mb-12  lg:mb-0 lg:flex lg:flex-col">
            <h2 className="headline-2 lg:max-w-[12ch] text-[#001d3d] dark:text-[#e2a837]">
              Contact me for collaboration
            </h2>

            <p className="dark:text-zinc-400 text-[#001d3d]/50 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch]">
              Reach out today to discuss your project needs and start collaborating on something amazing!
            </p>

            <div className="flex items-center gap-2 mt-auto ">
              {socialLinks.map(({ href, icon }, key) => (
                <a key={key} href={href} target="_blank" className="w-12 h-12 grid place-items-center ring-inset dark:ring-2 ring-1 dark:ring-zinc-50/5 ring-[#001d3d]/50 rounded-lg transition-[background-color, color] dark:text-zinc-50 text-[#001d3d] dark:hover:bg-zinc-50 hover:bg-[#001d3d] dark:hover:text-zinc-950 hover:text-[#ffffff] active:bg-zinc-50/80">
                    {icon}
                </a>
              ))}
            </div>
              ...
              <form action="https://getform.io/f/amdmpjlb" method="POST" className="xl:pl-10 2xl:pl-20 ">
                ...
                <div className="md:grid md:items-center md:grid-cols-2 md:gap-2 ">
                  <div className="mb-4 ">
                    ...
                    <input type="text" name="name" id="name" autoComplete="name" required placeholder="John Doe" className="text-field" />
                  </div>
                   ...
                   <div className="mb-4">
                    ...
                    <input type="email" name="email" id="email" autoComplete="email" required placeholder="jdoe@example.com" className="text-field" />
                  </div>
                </div>
                ...
                <div className="mb-4">
                  ...
                  <textarea name="message" id="message" placeholder="Hi!" required className="text-field resize-y mmin-h-32 max-h-80">
